...
namespace StockMarket
{
    public class Investor
    {
        ...
        {
            if (this.Portfolio.Any(x => x.Name == companyName))
            {
                Stock stock = this.Portfolio.First(x => x.Name == companyName);
        ...
        {
            return this.Portfolio.FirstOrDefault(x => x.Name == companyName);
        }
