...
namespace StockMarket
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            // Sell a stock
            Console.WriteLine(investor.SellStock("IfM", 150.00m)); // "IBM was sold."
                                                                   // Add stocks
            ...
            Console.WriteLine(investor.SellStock("IfM", 120.00m)); // "IBM was sold."


            // Buy more stocks
            investor.BuyStock(teslaStock);
            Console.WriteLine(investor.SellStock("IBM", 120.00m)); // "IBM was sold."
